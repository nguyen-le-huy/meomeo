...
const vocabularySchema = new mongoose.Schema(
  {
    ...
    audioProvider: { type: String, enum: ["openai", "elevenlabs", "manual", ""], default: "" },
    exampleAudioUrl: { type: String, default: "" },
    exampleAudioPublicId: { type: String, default: "" },
    exampleAudioProvider: { type: String, enum: ["openai", "elevenlabs", "manual", ""], default: "" },
